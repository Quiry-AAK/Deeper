...
{
    /// <summary>
    /// The authored map of `CombatRoom_UpperCaves_04` — Combat Room 3 of 6.
    ///
    ...
    ///
    /// **Its character:** west hall, east pocket. The band sits deep (column 7), so the long approach is the fight and the eastern quarter is the retreat — the mirror of room 03.
    ///
    ...
    /// </summary>
    public static class Layout_UpperCaves_04
    {
        ...
        [MenuItem("Deeper/Build Combat Room 04 Layout")]
        private static void PaintSelection()
        {
            if (!RoomLayout.Validate(Map, "Layout_UpperCaves_04")) return;
